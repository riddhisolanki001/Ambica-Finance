        ...
        if (frm.doc.category) {
            frappe.call({
                ...
                callback: function (r) {
                    ...
                    var categoryType = category.split(' - ')[0];
                    ...
                    row_twcategory.base_amount = r.message.invoices_for_category[0].base_amount;
                    row_twcategory.tds_rate = r.message.twcategory[0].tax_withholding_rate;
                    row_twcategory.tds_amount = r.message.invoices_for_category[0].tds_amount;
                    ...
                    row_twc.base_amount = r.message.invoices_fortwc[0].base_amount;
                    row_twc.tds_rate = r.message.twc[0].tax_withholding_rate;
                    row_twc.tds_amount = r.message.invoices_fortwc[0].tds_amount;
                    ...
                    if(categoryType=="TDS"){
                        ...
                        frappe.call({
                            ...
                            args: {
                                ...
                                filters: {
                                    'custom_tax_withholding_category': ['like', category_pattern],
                                    'posting_date': ['between', [frm.doc.from_date, frm.doc.to_date]]
                                },
                                fields: ['name','debit_to', 'total', 'custom_tax_withholding_category', 'taxes.tax_amount'],
                            },
                            callback: function (invoices) {
                                console.log("Invoices : ",invoices.message);   
                                ...
                                frappe.call({
                                    ...
                                    callback: function (twcItem) {
                                        ...
                                        for (let invoice of invoices.message) {
                                            let row = frappe.model.add_child(frm.doc, 'TDS Reference', 'tds_reference');
                                            row.title = invoice.debit_to;
                                            row.category = invoice.custom_tax_withholding_category;
                                            row.base_amount = invoice.total;
                                            row.tds_amount = invoice.tax_amount;
                                            ...
                                            for (let twcItem of twcItemMessage) {
                                                // Check if tax_withholding_category name matches
                                                if (invoice.custom_tax_withholding_category == twcItem.name) {
                                                    console.log(twcItem.tax_withholding_rate)
                                                    row.rate = twcItem.tax_withholding_rate;
                                                    // You can set other fields based on your logic
                                                }
